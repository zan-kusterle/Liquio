	...
	<div v-if="node">
		<div class="main" v-if="node.title.length > 0">
			<div class="inset-top" style="text-align: left;">
				<get-reference v-bind:id="node.url_key" enable-search="false" is-inverse="true" style="margin-bottom: 40px; text-align: center;"></get-reference>
			...
			<div class="inset-bottom">
				...
				<get-reference v-bind:id="node.url_key" enable-search="false" style="margin-top: 30px; text-align: center;"></get-reference>
			</div>
		</div>
		<div class="main" v-else>
			<div class="main-node">
				<get-reference enable-search="true" style="margin-bottom: 30px; text-align: center;"></get-reference>
...
export default {
	components: {App, CalculationOptions, LiquioNode, LiquioList, GetReference},
	data: function() {
		return {}
	},
	created: function() {
